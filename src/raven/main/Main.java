...
import component.ERPAppGridPanel;
import component.HomeForm;
import component.HotelPlanner;
import component.LeadPanel;
import component.LeadSourcePanel;
import component.POSPanel;
import component.crm.DashboardPanel;
import component.crm.DashboardPanel.AppName;
import component.sms.SMSPanel;
import component.sms.TemplateMapperPanel;
...
public class Main extends javax.swing.JFrame {
    public  AppName selectedApp = null;
    /**
        ...
        menu1.setEvent(new MenuEvent() {
            ...
            public void selected(int index, int subIndex) {
                if(index == 0) {
                    ...
                    showForm(new ERPAppGridPanel(Main.this));
                }
                else {
                    switch(index){
                        case 1:{
                            ...
                            if(subIndex == 3){
                               showForm(new SMSPanel()); break; 
                                 
                            }
                        }
                        
//                        default:showForm(new DefaultForm("Form : " + index + " " + subIndex));
                        default: showForm(new HotelPlanner()); 
    ...
    public  void showApp(AppName appName){
        ...
        DashboardPanel app = new DashboardPanel(this.selectedApp); 
        
        if(!app.isAppReady()){
            JOptionPane.showMessageDialog(this, appName+" cannot be launched. Consult developer!", "App Not Ready", JOptionPane.WARNING_MESSAGE);
            return;
        }
        this.showForm(app);
